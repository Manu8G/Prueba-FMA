...
class TareaService:
  ...
  def crear_tarea(self, nueva_tarea: Tarea):
    try:
  ...
  def leer_tarea(self, id_tarea: str):
    try:  
  ...
  def listar_tareas(self, id_usuario: str):
    try:  
  ...
  def actualizar_tarea(self, id_tarea: str, tareaModificada: Tarea):
    try:  
